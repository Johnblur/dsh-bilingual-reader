	...
	return function BilingualReader(props) {
		...
		return h("div", { style: {
			...
			return h("div", { style: { marginTop: 8 } }, h("button", {
				...
				lineHeight: 1.6
			} }, detected ? h("div", {}, "识别为：" + detected) : void 0, domain ? h("div", {}, "手动指定领域：" + domainLabel(domain)) : void 0, detectedDomain ? h("div", {}, "LLM 判断领域：" + domainLabel(detectedDomain)) : void 0, loadErr ? h("div", { style: { color: "var(--dsw-alias-state-warn-primary)" } }, loadErr) : void 0, matchSel.kind !== "empty" ? h("div", {}, matchSel.kind === "matched" ? "已匹配到原文，使用上下文翻译" : matchSel.kind === "multiple" ? "该片段在原文出现 " + (matchSel.count ?? 0) + " 次，使用第一次出现的上下文" : "未在原文中定位到该片段，直接翻译") : void 0) : void 0);
