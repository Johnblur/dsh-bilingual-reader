...
function makeReader({ h, useState, useEffect, useCallback, useRef }) {
	...
	return function BilingualReader(props) {
		...
		return h("div", { style: {
		...
		} }, "识别为：" + detected) : void 0, detectedDomain && !domain ? h("div", { style: {
			marginTop: 8,
			fontSize: 12,
			color: "var(--dsw-alias-label-tertiary)"
		} }, "LLM 判断领域：" + domainLabel(detectedDomain)) : void 0, domain && termWarnings.length > 0 ? h("div", { style: {
			marginTop: 8,
			fontSize: 12,
			...
			key: i,
			style: { marginTop: 2 }
		}, "· " + w))) : void 0, h("div", { style: { marginTop: 10 } }, sel ? h("div", { style: {
			display: "flex",
			flexDirection: "column",
			gap: 6
